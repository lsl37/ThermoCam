within ThermoCam.Tests.Sources;

model Source_pT
  //Source model, required to specify massflow, pressure and temperature
  ...
  parameter Modelica.SIunits.MassFlowRate m_flow "unit=kg/s";
