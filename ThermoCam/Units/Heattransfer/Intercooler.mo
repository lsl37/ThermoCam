...
model Intercooler
  ...
  Modelica.SIunits.TemperatureDifference DThot "unit=K";
...
/* Fluid Properties */
  ...
  T_ex_hot = T_su_hot - DThot;
  T_ex_cold = T_su_hot - DTpinch;
  
//Pinch point based on minimum addmissible temperature difference
